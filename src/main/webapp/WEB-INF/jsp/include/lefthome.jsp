...
<aside>
 <div id="home_user_info">
  <div id="foto"><img src="${pageContext.request.contextPath}/image/user" width="60"></div>
...
<table>
	<tr><th>${fn:length(user.aktivity)}</th><th>${fn:length(user.pratele)}</th><th>${fn:length(sledovan)}</th></tr>
	<tr><td>Aktivity</td><td>Sleduje</td><td>Sledován</td></tr>
</table>
 
  </div>
  <div id="pridatAktivituHome">
   <form action="${pageContext.request.contextPath}/aktivity/pridatAktivitu" method="get">
	<input type="submit" name="Přidat aktivitu" value="Přidat aktivitu" id="pridatAktivituButton">
   </form>
  </div>
 <c:choose>
