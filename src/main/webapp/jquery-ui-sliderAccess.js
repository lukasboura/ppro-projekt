...
<meta content="bd/TDsDgrX2TdNqlW9pxDlRX7JgQ5IjkAcL3C58e7Pw=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/assets/github-e37bfdbbcd6bc4520fd7e2ebfb33db3b5a09c985.js" type="text/javascript"></script>
        ...
        <link rel='permalink' href='/trentrichardson/jQuery-Timepicker-Addon/blob/d9e9d7cd7912d69b232dc87263f0339a6f166ccd/jquery-ui-sliderAccess.js'>
...
<ul class="top-nav">
  ...
  <li class="features"><a href="https://github.com/features">Features</a></li>
    <li class="blog"><a href="https://github.com/blog">Blog</a></li>
            ...
            <div class="header-actions">
              ...
              <a class="button classy" href="https://github.com/login?return_to=%2Ftrentrichardson%2FjQuery-Timepicker-Addon%2Fblob%2Fmaster%2Fjquery-ui-sliderAccess.js">Sign in</a>
            </div>
      ...
      <div class="hentry">
        ...
        <div class="pagehead repohead instapaper_ignore readability-menu">
          ...
          <li>
            <span class="star-button"><a href="/login?return_to=%2Ftrentrichardson%2FjQuery-Timepicker-Addon" class="minibutton js-toggler-target entice tooltipped leftwards" title="You must be signed in to use this feature" rel="nofollow"><span class="mini-icon mini-icon-star"></span>Star</a><a class="social-count js-social-count" href="/trentrichardson/jQuery-Timepicker-Addon/stargazers">1,289</a></span>
          </li>
          <li>
            <a href="/login?return_to=%2Ftrentrichardson%2FjQuery-Timepicker-Addon" class="minibutton js-toggler-target fork-button entice tooltipped leftwards"  title="You must be signed in to fork a repository" rel="nofollow"><span class="mini-icon mini-icon-fork"></span>Fork</a><a href="/trentrichardson/jQuery-Timepicker-Addon/network" class="social-count">345</a>
          </li>
    </ul>
  ...
  <ul class="tabs">
    ...
    <li><a href="/trentrichardson/jQuery-Timepicker-Addon/pulls" highlight="repo_pulls">Pull Requests <span class='counter'>3</span></a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/trentrichardson/jQuery-Timepicker-Addon/tags" class="tabnav-tab" highlight="repo_tags">Tags <span class="counter ">19</span></a></li>
    </ul>
          ...
          <div class="js-filter-tab js-filter-branches">
            <div data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target ">
                  ...
                  <h4>
                      <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/dev/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="dev" rel="nofollow">dev</a>
                  </h4>
                </div>
                <div class="commitish-item branch-commitish selector-item js-navigation-item js-navigation-target selected">
                  <span class="mini-icon mini-icon-confirm"></span>
                  <h4>
                      <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/master/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="master" rel="nofollow">master</a>
                  </h4>
                </div>
            </div>
            ...
            <div class="js-filter-tab js-filter-tags " style="display:none">
              <div data-filterable-for="context-commitish-filter-field" data-filterable-type=substring>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.1.1/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.1.1" rel="nofollow">v1.1.1</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.1.0/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.1.0" rel="nofollow">v1.1.0</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.5/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.5" rel="nofollow">v1.0.5</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.4/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.4" rel="nofollow">v1.0.4</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.3/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.3" rel="nofollow">v1.0.3</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.2/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.2" rel="nofollow">v1.0.2</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.1/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.1" rel="nofollow">v1.0.1</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v1.0.0/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v1.0.0" rel="nofollow">v1.0.0</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.9/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.9" rel="nofollow">v0.9.9</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.8/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.8" rel="nofollow">v0.9.8</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.7/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.7" rel="nofollow">v0.9.7</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.6/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.6" rel="nofollow">v0.9.6</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.5/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.5" rel="nofollow">v0.9.5</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.4/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.4" rel="nofollow">v0.9.4</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.3/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.3" rel="nofollow">v0.9.3</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.2/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.2" rel="nofollow">v0.9.2</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9.1/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9.1" rel="nofollow">v0.9.1</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.9/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.9" rel="nofollow">v0.9</a>
                    </h4>
                  </div>
                  <div class="commitish-item tag-commitish selector-item js-navigation-item js-navigation-target ">
                    <span class="mini-icon mini-icon-confirm"></span>
                    <h4>
                        <a href="/trentrichardson/jQuery-Timepicker-Addon/blob/v0.8/jquery-ui-sliderAccess.js" class="js-navigation-open" data-name="v0.8" rel="nofollow">v0.8</a>
                    </h4>
                  </div>
              </div>
              <div class="no-results">Nothing to show</div>
...
<div id="slider">
  ...
  <div class="commit file-history-tease">
    ...
    <div class="frames">
      <div class="frame" data-permalink-url="/trentrichardson/jQuery-Timepicker-Addon/blob/d9e9d7cd7912d69b232dc87263f0339a6f166ccd/jquery-ui-sliderAccess.js" data-title="jQuery-Timepicker-Addon/jquery-ui-sliderAccess.js at master · trentrichardson/jQuery-Timepicker-Addon · GitHub" data-type="blob">
          ...
          <div class="file">
            <div class="meta">
              ...
              <ul class="button-group actions">
                ...
                <li><a href="/trentrichardson/jQuery-Timepicker-Addon/raw/master/jquery-ui-sliderAccess.js" class="minibutton grouped-button bigger lighter" id="raw-url">Raw</a></li>
                  <li><a href="/trentrichardson/jQuery-Timepicker-Addon/blame/master/jquery-ui-sliderAccess.js" class="minibutton grouped-button bigger lighter">Blame</a></li>
                <li><a href="/trentrichardson/jQuery-Timepicker-Addon/commits/master/jquery-ui-sliderAccess.js" class="minibutton grouped-button bigger lighter" rel="nofollow">History</a></li>
              </ul>
            </div>
...
<div id="js-frame-loading-template" class="frame frame-loading large-loading-area" style="display:none;">
  ...
  <div class="container clearfix">
    ...
    <p class="right">&copy; 2012 <span title="0.07369s from fe17.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
